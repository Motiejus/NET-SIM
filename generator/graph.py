...
def run():
    ...
    with Graph(dimensions=8, latency=(5, 5), bandwidth=(100, 100)) as g:
    ...
    with Graph(dimensions=8, latency=(5, 5), bandwidth=(100, 100),
            tight=True) as g:
        write_graph_data(g, "8x8_t_fix")

    # 8x8 nice order, some randomness
    with Graph(dimensions=8, latency=(2, 5), bandwidth=(50, 500)) as g:
    ...
    with Graph(dimensions=8, latency=(2, 5), bandwidth=(50, 500),
            tight=True) as g:
        write_graph_data(g, "8x8_t_rand")


    ## 100x100 nice order, all fixed
    #with Graph(dimensions=100, latency=(5, 5), bandwidth=(100, 100)) as g:
    ...
    #with Graph(dimensions=100, latency=(5, 5), bandwidth=(100, 100),
    #        tight=True) as g:
    #    write_graph_data(g, "100x100_a_fix")

    ## 100x100 nice order, some randomness
    #with Graph(dimensions=100, latency=(2, 5), bandwidth=(50, 500)) as g:
    ...
    #with Graph(dimensions=100, latency=(2, 5), bandwidth=(50, 500),
    #        tight=True) as g:
